...
class FavoriteItem {
  ...
  factory FavoriteItem.fromJson(Map<String, dynamic> json) => FavoriteItem(
        ...
        targetScreen: TargetScreen.values.firstWhere((s) => s.byte == json['targetScreen']),
        textContent: json['textContent'] != null
            ? TextContent.fromJson(Map<String, dynamic>.from(json['textContent'] as Map))
            : null,
        animation: json['animation'] != null
            ? PixelAnimation.fromJson(Map<String, dynamic>.from(json['animation'] as Map))
            : null,
      );
}
