...
class ScrollingTextPreview extends StatefulWidget {
  const ScrollingTextPreview({super.key, required this.content, this.width = 160});
...
class _ScrollingTextPreviewState extends State<ScrollingTextPreview> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final textStyle = TextStyle(
      ...
      fontSize: _fontSize,
      fontWeight: content.font == GlassesFont.bold ? FontWeight.bold : FontWeight.normal,
    ...
    switch (content.direction) {
      case ScrollDirectionMode.static_:
        return GlassesScreenFrame(
          ...
          child: Center(child: Padding(padding: const EdgeInsets.all(8), child: textWidget)),
        );
